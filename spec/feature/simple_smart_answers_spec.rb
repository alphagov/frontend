RSpec.describe "SimpleSmartAnswers", type: :feature do
  before do
    @payload = { base_path: "/the-bridge-of-death", document_type: "simple_smart_answer", schema_name: "simple_smart_answer", title: "The Bridge of Death", description: "Cheery description about bridge of death", phase: "beta", public_updated_at: "2013-06-25T11:59:04+01:00", details: { start_button_text: "Start now", body: "<h2>STOP!</h2>\n\n<p>He who would cross the Bridge of Death<br />\nMust answer me<br />\nThese questions three<br />\nEre the other side he see.</p>\n", nodes: [{ kind: "question", slug: "what-is-your-name", title: "What...is your name?", body: "<p class=\"small\">It's the old man from Scene 24!!</p>\n", options: [{ label: "Sir Lancelot of Camelot", slug: "sir-lancelot-of-camelot", next_node: "what-is-your-favorite-colour" }, { label: "Sir Robin of Camelot", slug: "sir-robin-of-camelot", next_node: "what-is-the-capital-of-assyria" }, { label: "Sir Galahad of Camelot", slug: "sir-galahad-of-camelot", next_node: "what-is-your-favorite-colour" }] }, { kind: "question", slug: "what-is-the-capital-of-assyria", title: "What...is the capital of Assyria?", body: "\n", options: [{ label: "I don't know THAT!!", slug: "i-don-t-know-that", next_node: "arrrrrghhhh" }] }, { kind: "question", slug: "what-is-your-favorite-colour", title: "What...is your favorite colour?", body: "\n", options: [{ label: "Blue", slug: "blue", next_node: "right-off-you-go" }, { label: "Blue... NO! YELLOOOOOOOOOOOOOOOOWWW!!!!", slug: "blue-no-yelloooooooooooooooowww", next_node: "arrrrrghhhh" }] }, { kind: "outcome", slug: "right-off-you-go", title: "Right, off you go.", body: "<p>Oh! Well, thank you. Thank you very much.</p>\n", options: [] }, { kind: "outcome", slug: "arrrrrghhhh", title: "AAAAARRRRRRRRRRRRRRRRGGGGGHHH!!!!!!!", body: "\n", options: [] }] } }
    ...
    within("#content") do
      ...
      within(".article-container") do
        within(".intro") do
          ...
          assert_has_button_as_link("Start now", href: "/the-bridge-of-death/y", start: true, rel: "nofollow")
        end
      end
    end
  ...
  it "handles the flow correctly" do
    ...
    within("#content") do
      within(".govuk-caption-l") { assert_page_has_content("The Bridge of Death") }
    ...
    within("#content .govuk-form-group") do
      ...
      within(".govuk-radios") do
        ...
        expect(options).to eq(["Sir Lancelot of Camelot", "Sir Robin of Camelot", "Sir Galahad of Camelot"])
      end
    end
    ...
    within(".govuk-summary-list") do
      ...
      within(".govuk-summary-list__value") do
        assert_page_has_content("Sir Lancelot of Camelot")
      end
  ...
  it "tells GA when we reach the end of the smart answer" do
    ...
    assert_current_url("/the-bridge-of-death/y")
    expect(page).not_to have_selector("[data-module='track-smart-answer ga4-auto-tracker'][data-smart-answer-node-type=outcome]")
    ...
    assert_current_url("/the-bridge-of-death/y/sir-lancelot-of-camelot/blue")
    expect(page).to have_selector("[data-module='track-smart-answer ga4-auto-tracker'][data-smart-answer-node-type=outcome]")
  ...
  it "handles empty form submissions correctly" do
    ...
    within("#content .govuk-form-group") do
      ...
      expect(page.has_selector?(".govuk-error-message", text: "Please answer this question")).to be false
    end

  ...
  context 'exit page tracking' do
    ...
    context 'guide format' do
      ...
      should "render exit html for guide" do
        ...
        mock_publications_api(slug, {:type => type, :parts => [{:table => {:body => 'Go here [local councils](http://example.com "Find your local council")  '}}]})
      ...
      should "return 403 if the target is not included publication" do
        ...
        mock_publications_api(slug, {:type => type, :parts => [{:table => {:body => "akdsjfhaksd aksdjfhkasd"}}]})

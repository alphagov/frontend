RSpec.describe "When Do The Clocks Change", type: :feature do
  before do
  ...
  it "displays the clocks change page" do
    ...
    within("#content") do
      ...
      within("article") do
        ...
        expect(rows).to eq([["Year", "Clocks go forward", "Clocks go back"], ["2012", "25 March", "28 October"], ["2013", "31 March", "27 October"], ["2014", "30 March", "26 October"]])

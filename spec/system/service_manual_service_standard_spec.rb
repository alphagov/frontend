RSpec.describe "Field of operation page" do
  describe "GET /<document_type>" do
    ...
    it "service standard page has a heading, summary and intro" do
      ...
      assert page.has_css?(".app-page-header__summary", text: "The Service Standard is a set of 18 criteria to help government create and run good digital services."), "No description found"
      assert page.has_css?(".app-page-header__intro", text: "All public facing transactional services must meet the standard. It’s used by departments and the Government Digital Service to check whether a service is good enough for public use."), "No body found"
    end
    ...
    it "service standard page has points" do
      ...
      within(points[0]) do
        assert_text("1. Understand user needs")
      ...
      within(points[1]) do
        assert_text("2. Do ongoing user research")
      ...
      within(points[2]) do
        assert_text("3. Have a multidisciplinary team")

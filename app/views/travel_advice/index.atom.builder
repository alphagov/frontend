atom_feed(:root_url => "https://www.gov.uk/travel-advice") do |feed|
  ...
  feed.updated(@countries.first['updated_at'])
  feed.author do |author|
    author.name "GOV.UK"
  end
  @countries.each do |country|
    feed.entry(country,
               :id => "tag:www.gov.uk,2005:/travel-advice/#{country['identifier']}/#{country['updated_at'].xmlschema}",
      ...
      entry.updated(country['updated_at'].xmlschema)

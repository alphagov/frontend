RSpec.describe CallForEvidence do
  ...
  it_behaves_like "it can have a running time period", "call_for_evidence", "open_call_for_evidence"
  ...
  it_behaves_like "it can have ways to respond", "call_for_evidence", "open_call_for_evidence"

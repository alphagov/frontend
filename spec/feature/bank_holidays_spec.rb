RSpec.describe "BankHolidays", type: :feature do
      ...
      within("article") do
        ...
        within(".govuk-tabs") do
          within("#england-and-wales") do
            ...
            assert_bank_holiday_table(title: "Upcoming bank holidays in England and Wales", year: "2012", rows: [["Date", "Day of the week", "Bank holiday"], ["25 December", "Tuesday", "Christmas Day"], ["26 December", "Wednesday", "Boxing Day"]])
            assert_bank_holiday_table(title: "Upcoming bank holidays in England and Wales", year: "2013", rows: [["Date", "Day of the week", "Bank holiday"], ["1 January", "Tuesday", "New Year\u2019s Day"], ["29 March", "Friday", "Good Friday"], ["1 April", "Monday", "Easter Monday"], ["6 May", "Monday", "Early May bank holiday"], ["27 May", "Monday", "Spring bank holiday"], ["26 August", "Monday", "Summer bank holiday"], ["25 December", "Wednesday", "Christmas Day"], ["26 December", "Thursday", "Boxing Day"]])
            assert_bank_holiday_table(title: "Past bank holidays in England and Wales", year: "2012", rows: [["Date", "Day of the week", "Bank holiday"], ["27 August", "Monday", "Summer bank holiday"], ["5 June", "Tuesday", "Queen\u2019s Diamond Jubilee (extra bank holiday)"], ["4 June", "Monday", "Spring bank holiday (substitute day)"], ["7 May", "Monday", "Early May bank holiday"], ["9 April", "Monday", "Easter Monday"], ["6 April", "Friday", "Good Friday"], ["2 January", "Monday", "New Year\u2019s Day (substitute day)"]])
          end

          within("#scotland") do
            expect(page).to have_link("Add bank holidays for Scotland to your calendar", href: "/bank-holidays/scotland.ics")
            assert_bank_holiday_table(title: "Upcoming bank holidays in Scotland", year: "2012", rows: [["Date", "Day of the week", "Bank holiday"], ["25 December", "Tuesday", "Christmas Day"], ["26 December", "Wednesday", "Boxing Day"]])
            assert_bank_holiday_table(title: "Upcoming bank holidays in Scotland", year: "2013", rows: [["Date", "Day of the week", "Bank holiday"], ["1 January", "Tuesday", "New Year\u2019s Day"], ["2 January", "Wednesday", "2nd January"], ["29 March", "Friday", "Good Friday"], ["6 May", "Monday", "Early May bank holiday"], ["27 May", "Monday", "Spring bank holiday"], ["5 August", "Monday", "Summer bank holiday"], ["2 December", "Monday", "St Andrew\u2019s Day (substitute day)"], ["25 December", "Wednesday", "Christmas Day"], ["26 December", "Thursday", "Boxing Day"]])
            assert_bank_holiday_table(title: "Past bank holidays in Scotland", year: "2012", rows: [["Date", "Day of the week", "Bank holiday"], ["30 November", "Friday", "St Andrew\u2019s Day"], ["6 August", "Monday", "Summer bank holiday"], ["5 June", "Tuesday", "Queen\u2019s Diamond Jubilee (extra bank holiday)"], ["4 June", "Monday", "Spring bank holiday (substitute day)"], ["7 May", "Monday", "Early May bank holiday"], ["6 April", "Friday", "Good Friday"], ["3 January", "Tuesday", "New Year\u2019s Day (substitute day)"], ["2 January", "Monday", "2nd January"]])
          end
          ...
          within("#northern-ireland") do
            ...
            assert_bank_holiday_table(title: "Upcoming bank holidays in Northern Ireland", year: "2012", rows: [["Date", "Day of the week", "Bank holiday"], ["25 December", "Tuesday", "Christmas Day"], ["26 December", "Wednesday", "Boxing Day"]])
            assert_bank_holiday_table(title: "Upcoming bank holidays in Northern Ireland", year: "2013", rows: [["Date", "Day of the week", "Bank holiday"], ["1 January", "Tuesday", "New Year\u2019s Day"], ["18 March", "Monday", "St Patrick\u2019s Day (substitute day)"], ["29 March", "Friday", "Good Friday"], ["1 April", "Monday", "Easter Monday"], ["6 May", "Monday", "Early May bank holiday"], ["27 May", "Monday", "Spring bank holiday"], ["12 July", "Friday", "Battle of the Boyne (Orangemen\u2019s Day)"], ["26 August", "Monday", "Summer bank holiday"], ["25 December", "Wednesday", "Christmas Day"], ["26 December", "Thursday", "Boxing Day"]])
            assert_bank_holiday_table(title: "Past bank holidays in Northern Ireland", year: "2012", rows: [["Date", "Day of the week", "Bank holiday"], ["27 August", "Monday", "Summer bank holiday"], ["12 July", "Thursday", "Battle of the Boyne (Orangemen\u2019s Day)"], ["5 June", "Tuesday", "Queen\u2019s Diamond Jubilee (extra bank holiday)"], ["4 June", "Monday", "Spring bank holiday"], ["7 May", "Monday", "Early May bank holiday"], ["9 April", "Monday", "Easter Monday"], ["6 April", "Friday", "Good Friday"], ["19 March", "Monday", "St Patrick\u2019s Day (substitute day)"], ["2 January", "Monday", "New Year\u2019s Day (substitute day)"]])
          end
        end
      end
    end

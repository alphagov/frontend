      ...
      within "article" do
        ...
        within ".govuk-tabs" do
          within "#england-and-wales" do
            ...
            assert_bank_holiday_table title: "Upcoming bank holidays in England and Wales",
                                      year: "2012",
                                      rows: [
            ...
            assert_bank_holiday_table title: "Past bank holidays in England and Wales",
                                      year: "2012",
                                      rows: [
          ...
          within "#scotland" do
            ...
            assert_bank_holiday_table title: "Upcoming bank holidays in Scotland",
                                      year: "2012",
                                      rows: [
                                        ["25 December", "Tuesday", "Christmas Day"],
                                        ["26 December", "Wednesday", "Boxing Day"],
            ...
            assert_bank_holiday_table title: "Past bank holidays in Scotland",
                                      year: "2012",
                                      rows: [
          ...
          within "#northern-ireland" do
            ...
            assert_bank_holiday_table title: "Upcoming bank holidays in Northern Ireland",
                                      year: "2012",
                                      rows: [
                                        ["25 December", "Tuesday", "Christmas Day"],
                                        ["26 December", "Wednesday", "Boxing Day"],
            ...
            assert_bank_holiday_table title: "Past bank holidays in Northern Ireland",
                                      year: "2012",
                                      rows: [
                                        ["27 August", "Monday", "Summer bank holiday"],

RSpec.shared_examples "it can have historical government information" do |document_type, example_name|
  before do
  ...
  it "knows it is part of historical government if it is not the current government" do
    ...
    expect(described_class.new(@content_store_response).historically_political?).to eq true
  end
  ...
  it "knows it is not part of historical government if it is the current government" do
    ...
    expect(described_class.new(@content_store_response).historically_political?).to eq false
  end

module Attachments
  ...
  included do
    def attachments
      return [] unless document_attachments

      docs = document_attachments.select { |a| !a.key?("locale") || a["locale"] == locale }
...
private
  ...
  def document_attachments
    @document_attachments ||= content_store_response.dig("details", "attachments")
  end
end

...
RSpec.describe "Places API" do
  ...
  describe "geojson" do
    it "returns geojson formatted data" do
      ...
      expect(response.body).to eq("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[\"51\",\"-0.01\"]},\"properties\":{\"name\":\"A place\",\"address\":\"Hello Town, AB12 3CD\"}}]}")
    end
  end
end

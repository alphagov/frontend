...
class TravelAdviceAtomTest < ActionDispatch::IntegrationTest
  ...
  context "aggregate feed" do
    ...
    should "display the list of countries as an atom feed" do
      ...
      assert page.has_xpath? ".//feed/entry[1]/link[@type='text/html' and @href='http://www.test.gov.uk/foreign-travel-advice/syria']"
      assert page.has_xpath? ".//feed/entry[1]/link[@type='application/atom+xml' and @href='http://www.test.gov.uk/foreign-travel-advice/syria.atom']"
      ...
      assert page.has_xpath? ".//feed/entry[2]/link[@type='text/html' and @href='http://www.test.gov.uk/foreign-travel-advice/luxembourg']"
      assert page.has_xpath? ".//feed/entry[2]/link[@type='application/atom+xml' and @href='http://www.test.gov.uk/foreign-travel-advice/luxembourg.atom']"

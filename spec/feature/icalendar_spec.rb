RSpec.describe "Icalendar", type: :feature do
  before do
  ...
  context "getting ICS version" do
    ...
    calendars = { "welsh" => "/gwyliau-banc/cymru-a-lloegr.ics", "welsh-scotland" => "/gwyliau-banc/yr-alban.ics", "welsh-nothern-ireland" => "/gwyliau-banc/gogledd-iwerddon.ics", "english" => "/bank-holidays/england-and-wales.ics", "english-scotland" => "/bank-holidays/scotland.ics", "english-northern-ireland" => "/bank-holidays/northern-ireland.ics" }
    calendars.each do |calendar, calendar_path|
      it "contains all events in #{calendar}" do
        visit(calendar_path)

        expect(page.status_code).to eq(200)
        expected_non_scottish_events = [{ "date" => "20120102", "title" => I18n.t("bank_holidays.new_year") }, { "date" => "20120604", "title" => I18n.t("bank_holidays.spring") }, { "date" => "20120827", "title" => I18n.t("bank_holidays.summer") }]
        expected_scottish_events = [{ "date" => "20120103", "title" => I18n.t("bank_holidays.new_year") }, { "date" => "20120604", "title" => I18n.t("bank_holidays.spring") }, { "date" => "20120806", "title" => I18n.t("bank_holidays.summer") }]
        common_expected_events = [{ "date" => "20120605", "title" => I18n.t("bank_holidays.queen_diamond") }, { "date" => "20121225", "title" => I18n.t("bank_holidays.christmas") }, { "date" => "20121226", "title" => I18n.t("bank_holidays.boxing_day") }, { "date" => "20130101", "title" => I18n.t("bank_holidays.new_year") }, { "date" => "20130329", "title" => I18n.t("bank_holidays.good_friday") }, { "date" => "20131225", "title" => I18n.t("bank_holidays.christmas") }, { "date" => "20131226", "title" => I18n.t("bank_holidays.boxing_day") }]

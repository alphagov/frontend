RSpec.describe CorporateInformationPage do
  ...
  describe "#corporate_information?" do
    it "presents corporate information groups on about pages" do
      expect(corporate_information_page.corporate_information?).to be(true)
    end
    ...
    it "does not present corporate information groups on about pages if information isn't available" do
      ...
      expect(corporate_information_page.corporate_information?).to be(false)
    end
  end

  describe "#corporate_information" do
    subject(:corporate_information) { corporate_information_page.corporate_information }
    ...
    context "with 'Access our information' section" do
      ...
      it "excludes group links that do not have matching guids" do
        ...
        corporate_information = corporate_information_page.corporate_information
  ...
  describe "#corporate_information_pages" do
    subject(:corporate_information_pages) { corporate_information_page.corporate_information_pages }

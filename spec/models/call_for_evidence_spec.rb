RSpec.describe CallForEvidence do
  ...
  it_behaves_like "it can be updated", "call_for_evidence", "open_call_for_evidence"

  describe "#related_entities" do
    it "returns the linkable organisations as well as people" do
      open_call_for_evidence.content_store_response["links"]["people"] = [
        {
      ...
      expect(open_call_for_evidence.people).to eq(open_call_for_evidence.content_store_response["links"]["people"])

      expect(open_call_for_evidence.related_entities).to include(open_call_for_evidence.people[0])
    end
  end
  ...
  describe "#held_on_another_website_url" do
    it "returns url if it is held on another website" do
      expect(open_call_for_evidence.held_on_another_website_url).to be(open_call_for_evidence.content_store_response.dig("details", "held_on_another_website_url"))
    end

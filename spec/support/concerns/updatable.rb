RSpec.shared_examples "it can be updated" do |schema, example_name = nil|
  let(:content_store_response) { GovukSchemas::Example.find(schema, example_name: example_name || schema) }

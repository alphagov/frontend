RSpec.describe "CorporateInformationPage" do
  context "when visiting a Corporate Information page" do
    ...
    context "when there is a contents list" do
      ...
      it "displays H2s in the list" do
        within(".gem-c-contents-list-with-body") do
          expect(page).to have_link("Our responsibilities", href: "#our-responsibilities")
        end
      end

      it "does not displays H3s in the list" do
        within(".gem-c-contents-list-with-body") do
          expect(page).not_to have_link("Audit and risk committee meetings", href: "#audit-and-risk-committee-meetings")
        end
      end
    end
  ...
  context "when visiting a Corporate Information page which is translatable" do
    ...
    context "when there are no headings in the body" do
      it "does not display a contents list" do
        within(".gem-c-contents-list-with-body") do
          expect(page).not_to have_css("h2", text: "Contents")
        end
      end
    end
  end

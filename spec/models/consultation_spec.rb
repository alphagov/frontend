RSpec.describe Consultation do
  ...
  it_behaves_like "it can have a running time period", "consultation", "open_consultation"
  ...
  it_behaves_like "it can have ways to respond", "consultation", "open_consultation"

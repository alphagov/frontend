...
class RootControllerTest < ActionController::TestCase
  ...
  test "should return a 404 if asked for a guide without parts" do
    ...
    content_api_has_metadata('slug' => "disability-living-allowance-guide")
  ...
  test "should return a 404 if api returns nil" do
    ...
    content_api_has_metadata('slug' => 'a-slug')
  ...
  test "further information tab should appear for programmes that have it" do
    ...
    content_api_has_metadata('slug' => 'zippy')
  ...
  test "further information tab should not appear for programmes that don't have it" do
    ...
    content_api_has_metadata('slug' => 'george')
  ...
  test "should pass edition parameter on to api to provide preview" do
    ...
    content_api_has_metadata('slug' => slug)
  ...
  test "should pass specific and general variables to template" do
    ...
    content_api_has_metadata('slug' => 'c-slug')
  ...
  test "should expose artefact details in header" do
    content_api_has_metadata('slug' => 'slug', 'section' => "rhubarb", 'need_id' => 42, 'kind' => "answer")
  ...
  test "should set proposition to citizen" do
    publication_exists('slug' => 'slug')
    content_api_has_metadata('slug' => 'slug', 'id' => '12345', 'section' => 'Test', 'need_id' => 123, 'kind' => 'guide')
    @controller.stubs(:render)
  ...
  test "should set proposition to business for business content" do
    publication_exists("slug" => "slug")
    content_api_has_metadata("slug" => "slug", "id" => "12345", "section" => "Test", "need_id" => 123, "kind" => "guide", "business_proposition" => true)
    @controller.stubs(:render)
  ...
  test "sets up a default artefact if content api isn't available" do
    @controller.content_api.stubs(:artefact_for_slug).returns(nil)
    @controller.stubs(:render)
    publication_exists('slug' => 'slug')

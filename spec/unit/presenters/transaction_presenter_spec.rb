RSpec.describe TransactionPresenter, type: :model do
  ...
  context "details" do
    before do
      @item = { details: { introductory_paragraph: "foo", more_information: "bar", other_ways_to_apply: "carrots", transaction_start_link: "bananas", what_you_need_to_know: "hats", will_continue_on: "scarves", start_button_text: "Start now" } }
    end

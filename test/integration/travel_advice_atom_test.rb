...
class TravelAdviceAtomTest < ActionDispatch::IntegrationTest
  ...
  context "aggregate feed" do
    setup do
      ...
      ArtefactStub.new('travel-advice').with_response_body({ 'results' => [
        { 
          ...
          'web_url' => 'https://www.gov.uk/travel-advice/luxembourg',
        ...
        },
        {
          ...
          'name' => 'Portugal',
          'identifier' => 'portugal',
          'web_url' => 'https://www.gov.uk/travel-advice/portugal',
        },
        {
          'id' => "#{endpoint}/travel-advice/syria.json",
          'name' => 'Syria',
          'identifier' => 'syria',
          'web_url' => 'https://www.gov.uk/travel-advice/syria',
    ...
    should "display the list of countries as an atom feed" do
      ...
      assert page.has_xpath? ".//feed/entry[1]/link[@type='text/html' and @href='https://www.gov.uk/travel-advice/syria']"
      assert page.has_xpath? ".//feed/entry[1]/link[@type='application/atom+xml' and @href='https://www.gov.uk/travel-advice/syria.atom']"
      ...
      assert page.has_xpath? ".//feed/entry[2]/link[@type='text/html' and @href='https://www.gov.uk/travel-advice/luxembourg']"
      assert page.has_xpath? ".//feed/entry[2]/link[@type='application/atom+xml' and @href='https://www.gov.uk/travel-advice/luxembourg.atom']"
      ...
      assert page.has_no_xpath? ".//feed/entry/link[@href='https://www.gov.uk/travel-advice/portugal']"
    end
  end
end

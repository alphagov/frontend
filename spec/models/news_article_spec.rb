RSpec.describe NewsArticle do
  %i[content_store publishing_api_graphql].each do |data_source|
    context "when data source is #{data_source}" do
      it_behaves_like "it has news image", "news_article", "news_article", data_source: data_source
    ...
    describe "#contributors" do
      ...
      let(:content_item) { fetch_content_item("news_article", "best-practice-government-response", data_source: data_source) }

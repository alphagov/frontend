module ApplicationHelper
  ...
  def show_breadcrumbs?(content_item)
    ...
    no_breadcrumbs_for = %w[flexible_page history homepage landing_page service_manual_homepage service_manual_guide service_manual_service_standard service_manual_service_toolkit service_manual_topic html_publication]

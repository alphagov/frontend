RSpec.describe "HelpCookies", type: :feature do
  context "rendering the cookies setting page" do
    before do
      payload = { base_path: "/help/cookies", format: "special_route", title: "Cookies on GOV.UK", description: "You can choose which cookies you're happy for GOV.UK to use." }
    ...
    it "renders the cookies setting page correctly" do
      ...
      within("#content") { assert_has_component_title("Cookies on GOV.UK") }
    end

APP_STYLESHEETS = {
  ...
  "views/_landing_page/map/leaflet.scss" => "views/_landing_page/map/leaflet.css",
  "views/_landing_page/map/os-api-branding.scss" => "views/_landing_page/map/os-api-branding.css",

  ...
  describe "#items" do
    ...
    context "when both the taxon base path and a hard-coded list is provided" do
      ...
      it "returns the hard-coded list if the taxon doesn't exist" do
        stub_content_store_does_not_have_item(basic_taxon["base_path"]) # The code in LandingPage::Block::DocumentList calls Content Store directly, without using the conditional loader

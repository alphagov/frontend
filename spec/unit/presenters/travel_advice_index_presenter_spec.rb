RSpec.describe TravelAdviceIndexPresenter, type: :model do
  context "handling countries" do
    ...
    let(:presenter) { TravelAdviceIndexPresenter.new(attributes) }
    ...
    describe "#countries_grouped_by_initial_letter" do
      let(:attributes) do
        {
          ...
          "details" => {
            "email_signup_link" => "/email/travel-advice",
          },
      ...
      let(:result) { presenter.countries_grouped_by_initial_letter }

RSpec.describe FaqPresenter, type: :model do
  before { @view_context = ApplicationController.new.view_context }

  it "uses bank holiday body for bank holidays" do
    expected = [q_and_a("England and Wales", "The next bank holiday in England and Wales is Good Friday on the 6th of April"), q_and_a("Scotland", "The next bank holiday in Scotland is Good Friday on the 6th of April"), q_and_a("Northern Ireland", "The next bank holiday in Northern Ireland is Good Friday on the 6th of April")]

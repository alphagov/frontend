RSpec.describe StatisticsAnnouncement do
  ...
  describe "#cancellation_reason" do
    ...
    it "returns the cancellation reason" do
      expect(cancelled_official_statistics.cancellation_reason).to eq("Official Statistics")
    end
  end
  ...
  describe "#previous_release_date" do
    ...
    it "returns the previous release date" do
      expect(statistics_announcement_with_release_date_changed.previous_release_date).to eq("19 January 2016 9:30am")
    end
  end

...
RSpec.describe "LicenceTransaction", type: :feature do
  ...
  before do
    @payload = { base_path: "/find-licences/licence-to-kill", document_type: "licence_transaction", schema_name: "specialist_document", title: "Licence to kill", public_updated_at: "2012-10-02T12:30:33.483Z", description: "Descriptive licence text.", details: { body: "You only live twice, Mr Bond.\n", metadata: { licence_transaction_licence_identifier: "1071-5-1" } } }
  end
  ...
  context "given a location specific licence" do
    before do
      ...
      stub_licence_exists("1071-5-1", "isLocationSpecific" => true, "isOfferedByCounty" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => [])
    end
    ...
    context "when visiting the licence search page" do
      ...
      it "renders the licence page" do
        ...
        within("#content") do
          within(".gem-c-title") { assert_has_component_title("Licence to kill") }
      ...
      it "adds google analytics tags for postcodeSearchStarted" do
        ...
        expect(track_category).to eq("postcodeSearch:licence")
    ...
    context "when visiting the licence with a valid postcode" do
      context "when it's a unitary or district local authority" do
        before do
          authorities = [{ "authorityName" => "Westminster City Council", "authoritySlug" => "westminster", "authorityContact" => { "website" => "", "email" => "", "phone" => "020 7641 6000", "address" => "P.O. Box 240\nWestminster City Hall\n\n\nSW1E 6QP" }, "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/westminster/apply-1", "description" => "Apply for your licence to kill", "payment" => "none", "introduction" => "This licence is issued shaken, not stirred.", "usesLicensify" => true }, { "url" => "/new-licence/westminster/apply-2", "description" => "Apply for your licence to hold gadgets", "payment" => "none", "introduction" => "Q-approval required.", "usesLicensify" => true }], "renew" => [{ "url" => "/new-licence/westminster/renew-1", "description" => "Renew your licence to kill", "payment" => "none", "introduction" => "", "usesLicensify" => true }] } }]
          stub_licence_exists("1071-5-1/00BK", "isLocationSpecific" => true, "isOfferedByCounty" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
        ...
        context "when visiting a licence action" do
          ...
          it "displays a button to apply for the licence" do
            assert_has_button_as_link("Apply online", href: "/new-licence/westminster/apply-1", start: true)
          end
        end
      ...
      context "when it's a county local authority" do
        before do
          ...
          authorities = [{ "authorityName" => "Buckinghamshire Council", "authoritySlug" => "buckinghamshire", "authorityContact" => { "website" => "", "email" => "", "phone" => "", "address" => "" }, "authorityInteractions" => { "apply" => [{ "url" => "/licence-to-kill/buckinghamshire/apply-1", "description" => "Apply for your licence to kill", "payment" => "none", "introduction" => "This licence is issued shaken, not stirred.", "usesLicensify" => true }, { "url" => "/licence-to-kill/buckinghamshire/apply-2", "description" => "Apply for your licence to hold gadgets", "payment" => "none", "introduction" => "Q-approval required.", "usesLicensify" => true }], "renew" => [{ "url" => "/licence-to-kill/buckinghamshire/renew-1", "description" => "Renew your licence to kill", "payment" => "none", "introduction" => "", "usesLicensify" => true }] } }]
          stub_licence_exists("1071-5-1/00BK", "isLocationSpecific" => true, "isOfferedByCounty" => true, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
          stub_licence_exists("1071-5-1", "isLocationSpecific" => true, "isOfferedByCounty" => true, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => [])
          visit "/find-licences/licence-to-kill"
        ...
        context "when the local authority doesn't have a SNAC" do
          before do
            ...
            authorities = [{ "authorityName" => "Dorset Council", "authoritySlug" => "dorset", "authorityContact" => { "website" => "", "email" => "", "phone" => "", "address" => "" }, "authorityInteractions" => { "apply" => [{ "url" => "/licence-to-kill/dorset/apply-1", "description" => "Apply for your licence to kill", "payment" => "none", "introduction" => "This licence is issued shaken, not stirred.", "usesLicensify" => true }, { "url" => "/licence-to-kill/dorset/apply-2", "description" => "Apply for your licence to hold gadgets", "payment" => "none", "introduction" => "Q-approval required.", "usesLicensify" => true }], "renew" => [{ "url" => "/licence-to-kill/dorset/renew-1", "description" => "Renew your licence to kill", "payment" => "none", "introduction" => "", "usesLicensify" => true }] } }]
            stub_licence_exists("1071-5-1/E06000069", "isLocationSpecific" => true, "isOfferedByCounty" => true, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
            visit "/find-licences/licence-to-kill"
      ...
      context "when there are more than one licensing authority" do
        before do
          authorities = [{ "authorityName" => "Westminster City Council", "authoritySlug" => "westminster", "authorityContact" => { "website" => "", "email" => "", "phone" => "020 7641 6000", "address" => "P.O. Box 240\nWestminster City Hall\n\n\nSW1E 6QP" }, "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/westminster/apply-1", "description" => "Apply for your licence to kill", "payment" => "none", "introduction" => "This licence is issued shaken, not stirred.", "usesLicensify" => true }] } }, { "authorityName" => "Kingsmen Tailors", "authoritySlug" => "kingsmen-tailors", "authorityContact" => { "website" => "", "email" => "", "phone" => "020 007 007", "address" => "Savile Row" }, "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/kingsmen-tailors/apply-1", "description" => "Apply for your licence to kill", "payment" => "none", "introduction" => "This licence is issued shaken, not stirred.", "usesLicensify" => true }] } }]
          stub_licence_exists("1071-5-1/00BK", "isLocationSpecific" => true, "isOfferedByCounty" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
          visit "/find-licences/licence-to-kill"
          fill_in("postcode", with: "SW1A 1AA")
          click_on("Find")
    ...
    context "when visiting a licence that has district and county authorities" do
      before do
        ...
        authority_for_staffordshire = [{ "authorityName" => "Staffordshire", "authoritySlug" => "staffordshire", "authorityInteractions" => { "apply" => [{ "url" => "/licence-to-kill/ministry-of-love/apply-1", "description" => "Apply for your Licence to kill", "payment" => "none", "introduction" => "", "usesLicensify" => true }] } }]
        authority_for_staffordshire_moorlands = [{ "authorityName" => "Staffordshire Moorlands", "authoritySlug" => "staffordshire-moorlands", "authorityInteractions" => {} }]
        ...
        stub_licence_exists("1071-5-1/41", "isLocationSpecific" => true, "isOfferedByCounty" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authority_for_staffordshire)
        stub_licence_exists("1071-5-1/41UH", "isLocationSpecific" => true, "isOfferedByCounty" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authority_for_staffordshire_moorlands)
    ...
    context "when visiting the licence transaction with a postcode where multiple authorities are found" do
      ...
      context "when there are 6 or more addresses to choose from" do
        before do
          stub_locations_api_has_location("CH25 9BJ", [{ "address" => "House 1", "local_custodian_code" => "1" }, { "address" => "House 2", "local_custodian_code" => "2" }, { "address" => "House 3", "local_custodian_code" => "3" }, { "address" => "House 4", "local_custodian_code" => "4" }, { "address" => "House 5", "local_custodian_code" => "5" }, { "address" => "House 6", "local_custodian_code" => "6" }, { "address" => "House 7", "local_custodian_code" => "7" }])
          stub_local_links_manager_has_a_local_authority("Achester", local_custodian_code: 1)
          stub_local_links_manager_has_a_local_authority("Beechester", local_custodian_code: 2)
          stub_local_links_manager_has_a_local_authority("Ceechester", local_custodian_code: 3)
  ...
  context "given a non-location specific licence" do
    before do
      @payload = { base_path: "/find-licences/licence-to-kill", document_type: "licence_transaction", schema_name: "specialist_document", title: "Licence to kill", public_updated_at: "2012-10-02T12:30:33.483Z", description: "Descriptive licence text.", details: { body: "You only live twice, Mr Bond.", metadata: { licence_transaction_licence_identifier: "1071-5-1" } } }
      stub_content_store_has_item("/find-licences/licence-to-kill", @payload)
    end

    context "with a single authority" do
      before do
        authorities = [{ "authorityName" => "Ministry of Love", "authoritySlug" => "miniluv", "authorityInteractions" => { "apply" => [{ "url" => "/licence-to-kill/ministry-of-love/apply-1", "description" => "Apply for your Licence to kill", "payment" => "none", "introduction" => "", "usesLicensify" => true }] } }]
        stub_licence_exists("1071-5-1", "isLocationSpecific" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
      end
      ...
      context "when visiting the licence" do
        ...
        it "displays the interactions for licence" do
          ...
          assert_has_button_as_link("Apply online", href: "/licence-to-kill/ministry-of-love/apply-1", start: true)
        end
  ...
  context "given a licence edition with continuation link" do
    before do
      @payload = { base_path: "/find-licences/artistic-license", document_type: "licence_transaction", schema_name: "specialist_document", title: "Artistic License", public_updated_at: "2012-10-02T12:30:33.483Z", description: "Descriptive licence text.", details: { metadata: { licence_transaction_will_continue_on: "another planet", licence_transaction_continuation_link: "http://gov.uk/blah" } } }
  ...
  context "given a licence which does not exist in licensify and uses authority url" do
    before do
      ...
      authorities = [{ "authorityName" => "A Council", "authoritySlug" => "a-council", "authorityContact" => { "website" => "", "email" => "", "phone" => "020 7641 6000", "address" => "P.O. Box 123\nSome Town\nXY1 1AB" }, "authorityInteractions" => { "apply" => [{ "url" => "http://some-council-website", "description" => "Apply for your licence", "payment" => "none", "introduction" => "This licence is issued online", "usesLicensify" => false, "usesAuthorityUrl" => true }] } }]
      stub_licence_exists("1071-5-1", "isLocationSpecific" => true, "isOfferedByCounty" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
      stub_licence_exists("1071-5-1/00BK", "isLocationSpecific" => true, "isOfferedByCounty" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
    end
  ...
  context "given the usesLicensify parameter" do
    ...
    context "when visiting an authority with no actions" do
      before do
        authorities = [{ "authorityName" => "Ministry of Love", "authoritySlug" => "miniluv", "authorityInteractions" => {} }]
        stub_licence_exists("1071-5-1", "isLocationSpecific" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
        visit "/find-licences/licence-to-kill"
      end
    ...
    context "when there's at least one action with usesLicensify set to true" do
      before do
        authorities = [{ "authorityName" => "Ministry of Love", "authoritySlug" => "miniluv", "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/ministry-of-love/apply-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => true }], "renew" => [{ "url" => "/new-licence/ministry-of-love/renew-1", "description" => "Renew your licence", "payment" => "none", "introduction" => "", "usesLicensify" => false }] } }]
        stub_licence_exists("1071-5-1", "isLocationSpecific" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
        visit "/find-licences/licence-to-kill"
      end
      ...
      it "displays the interactions for the licence if usesLicensify is set to true" do
        ...
        assert_has_button_as_link("Apply online", href: "/new-licence/ministry-of-love/apply-1", start: true)
      ...
      it "does not display the interactions for the licence if usesLicensify is set to false" do
        ...
        refute_has_button_component("Apply online", href: "/new-licence/ministry-of-love/renew-1", start: true)
        expect(page).to have_content("You cannot apply for this licence online")
        expect(page).to have_content("Contact your local council")
      end
    end
    ...
    context "when all actions have usesLicensify set to false" do
      before do
        authorities = [{ "authorityName" => "Ministry of Love", "authoritySlug" => "miniluv", "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/ministry-of-love/apply-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => false }], "renew" => [{ "url" => "/new-licence/ministry-of-love/renew-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => false }] } }]
        stub_licence_exists("1071-5-1", "isLocationSpecific" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
        visit "/find-licences/licence-to-kill"
      end
      ...
      it "displays the licence unavailable message after you click on the first action" do
        ...
        expect(current_path).to eq("/find-licences/licence-to-kill/miniluv/apply")
        refute_has_button_component("Apply online", href: "/new-licence/ministry-of-love/apply-1", start: true)
        expect(page).to have_content("You cannot apply for this licence online")
        expect(page).to have_content("Contact your local council")
      end
    ...
    context "when usesLicensify is missing for one action" do
      before do
        authorities = [{ "authorityName" => "Ministry of Love", "authoritySlug" => "miniluv", "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/ministry-of-love/apply-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "" }], "renew" => [{ "url" => "/new-licence/ministry-of-love/renew-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => true }] } }]
        stub_licence_exists("1071-5-1", "isLocationSpecific" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
        visit "/find-licences/licence-to-kill"
      end
      ...
      it "displays interactions for licence with usesLicensify set to true" do
        ...
        expect(current_path).to eq("/find-licences/licence-to-kill/miniluv/renew")
        assert_has_button_as_link("Apply online", href: "/new-licence/ministry-of-love/renew-1", start: true)
        expect(page).not_to have_content("You cannot apply for this licence online")
        expect(page).not_to have_content("Contact your local council")
      end
    end
    ...
    context "when usesLicensify is missing for all actions" do
      before do
        authorities = [{ "authorityName" => "Ministry of Love", "authoritySlug" => "miniluv", "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/ministry-of-love/apply-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "" }], "renew" => [{ "url" => "/new-licence/ministry-of-love/renew-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "" }] } }]
        stub_licence_exists("1071-5-1", "isLocationSpecific" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
        visit "/find-licences/licence-to-kill"
      end
    ...
    context "when an action has multiple links, some with usesLicensify set to true" do
      before do
        authorities = [{ "authorityName" => "Ministry of Love", "authoritySlug" => "miniluv", "authorityInteractions" => { "apply" => [{ "url" => "/new-licence/ministry-of-love/apply-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => true }, { "url" => "/new-licence/ministry-of-love/apply-2", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => false }, { "url" => "/new-licence/ministry-of-love/apply-3", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => true }], "renew" => [{ "url" => "/new-licence/ministry-of-love/renew-1", "description" => "Apply for your licence", "payment" => "none", "introduction" => "", "usesLicensify" => false }, { "url" => "/new-licence/ministry-of-love/renew-2", "description" => "Apply for your licence", "payment" => "none", "introduction" => "" }] } }]
        stub_licence_exists("1071-5-1", "isLocationSpecific" => false, "geographicalAvailability" => %w[England Wales], "issuingAuthorities" => authorities)
        visit "/find-licences/licence-to-kill"
      end
      ...
      it "displays the interactions for the licence if usesLicensify is set to true for a link" do
        ...
        expect(current_path).to eq("/find-licences/licence-to-kill/miniluv/apply")
        assert_has_button_as_link("Apply online", href: "/new-licence/ministry-of-love/apply-1", start: true)
        assert_has_button_as_link("Apply online", start: true, href: "/new-licence/ministry-of-love/apply-3")
        refute_has_button_component("Apply online", href: "/new-licence/ministry-of-love/apply-2", start: true)
        expect(page).to have_content("You cannot apply for this licence online")
        expect(page).to have_content("Contact your local council")
      end
      ...
      it "does not display the interactions for the licence if usesLicensify is set to false or is missing for a link" do
        ...
        expect(current_path).to eq("/find-licences/licence-to-kill/miniluv/renew")
        refute_has_button_component("Apply online", href: "/new-licence/ministry-of-love/renew-1", start: true)
        refute_has_button_component("Apply online", href: "/new-licence/ministry-of-love/renew-2", start: true)
        expect(page).to have_content("You cannot apply for this licence online")
        expect(page).to have_content("Contact your local council")
      end
    end

describe "SubscribeComponent", type: :view do
  def component_name
    "subscribe"
  end
  ...
  it "renders the component when link data is passed" do
    render_component(label: "label", url: "https://www.gov.uk", title: "title")
  ...
  it "renders the component with data attributes" do
    render_component(label: "label", url: "https://www.gov.uk", title: "title", data: { module: "test-module", ok: "go" })
    assert_select(".app-c-subscribe a[href='https://www.gov.uk'][title='title']", text: "label")

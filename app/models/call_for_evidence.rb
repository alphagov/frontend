class CallForEvidence < ContentItem
  ...
  def outcome_detail
    content_store_response["details"]["outcome_detail"]
  end

  # Read the full outcome, top of page
  def outcome_documents
    attachments_from(content_store_response["details"]["outcome_attachments"])
  end
  ...
  def held_on_another_website_url
    content_store_response["details"]["held_on_another_website_url"]
  end
...
private
  ...
  def ways_to_respond
    content_store_response["details"]["ways_to_respond"]
  end
end
